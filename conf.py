...
parser.add_argument('--lam2', default=0.001, type=float, help="lambda for adjusting loss")
parser.add_argument('--lam3', default=0.001, type=float, help="lambda for adjusting loss")
